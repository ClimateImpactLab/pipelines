...
Report bugs at https://github.com/ClimateImpactLab/pipelines/issues.
...
pipelines could always use more documentation, whether as part of the
...
The best way to send feedback is to file an issue at https://github.com/ClimateImpactLab/pipelines/issues.
...
Install your local copy into a conda env. Assuming you have virtualenvwrapper
installed, this is how you set up your fork for local development::

    $ conda create -n pipelines python=2.7
    $ conda install --file ci/requirements_conda.txt
    $ pip install -r ci/requirements.txt

Developing your feature
~~~~~~~~~~~~~~~~~~~~~~~

When making any changes to the pipelines codebase, follow the following steps:

1.  Check for issues on our
    `issues <https://github.com/ClimateImpactLab/pipelines/issues>`_ page. If no
...
2. Fork the `pipelines` repo on GitHub.

3. Clone your fork locally::

    $ git clone git@github.com:your_name_here/pipelines.git
...
6.  Implement your feature, writing as little code as is required to satisfy the
    ...
    compatibility with the rest of the package::
        ...
        $ flake8 pipelines tests examples docs
