...
extlinks = {
    'issue': ('https://github.com/ClimateImpactLab/pipelines/issues/%s', 'GH #'),
    'pull': ('https://github.com/ClimateImpactLab/pipelines/pull/%s', 'PR #')}
...
project = u'Climate Impact Lab Job Pipeline'
...
latex_documents = [
    ('index', 'pipelines.tex',
     u'Climate Impact Lab Job Pipeline Documentation',
...
texinfo_documents = [
    ('index', 'pipelines',
     ...
     'pipelines',
     'Pipeline definitions for the Climate Impact Lab.',
     'Miscellaneous'),
]
